...
@router.post("3")
async def schema_version_3(collection: Annotated[Union[CollectionCreate2, CollectionCreate3], File()]) -> CollectionOut:
...
@router.post("4")
async def schema_version_4(collection: Annotated[CollectionCreate4, File()]) -> CollectionOut:
...
@router.post("5")
async def schema_version_5(collection: Annotated[CollectionCreate5, File()]) -> CollectionOut:
...
@router.post("6")
async def schema_version_6(collection: Annotated[CollectionCreate6, File()]) -> CollectionOut:
...
@router.post("7")
async def schema_version_7(collection: Annotated[CollectionCreate7, File()]) -> CollectionOut:
...
@router.post("8")
async def schema_version_8(collection: Annotated[CollectionCreate8, File()]) -> CollectionOut:
...
@router.post("9")
async def schema_version_9(collection: Annotated[CollectionCreate9, File()]) -> CollectionOut:
