...
@router.post("4")
async def schema_version_4(collection: Annotated[CollectionCreate4, File()], session: Session = Depends(db.get_session)) -> CollectionOut:
...
@router.post("5")
async def schema_version_5(collection: Annotated[CollectionCreate5, File()], session: Session = Depends(db.get_session)) -> CollectionOut:
...
@router.post("6")
async def schema_version_6(collection: Annotated[CollectionCreate6, File()], session: Session = Depends(db.get_session)) -> CollectionOut:
...
@router.post("7")
async def schema_version_7(collection: Annotated[CollectionCreate7, File()], session: Session = Depends(db.get_session)) -> CollectionOut:
...
@router.post("8")
async def schema_version_8(collection: Annotated[CollectionCreate8, File()], session: Session = Depends(db.get_session)) -> CollectionOut:
...
@router.post("9")
async def schema_version_9(collection: Annotated[CollectionCreate9, File()], session: Session = Depends(db.get_session)) -> CollectionOut:
