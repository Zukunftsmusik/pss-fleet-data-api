...
def test_get_alliance_history_invalid_id(alliance_id: int, assert_error_code, client: TestClient):
    with client:
...
def test_get_alliance_history_non_existing_id(assert_error_code, client: TestClient):
    with client:
