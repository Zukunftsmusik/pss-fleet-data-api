...
def test_get_alliances_from_collection_invalid_id(
...
def test_get_alliances_from_collection_non_existing_id(assert_error_code: Callable[[HttpXResponse, ErrorCode], None], client: TestClient):
    with client:
