...
def _create_collection_metadata_create_4(schema_version: int = None) -> CollectionMetadataCreate4:
    return CollectionMetadataCreate4(timestamp=datetime(2016, 1, 6, 23, 59), duration=11.2, fleet_count=1, user_count=1, tourney_running=False, schema_version=schema_version or 4)


def _create_collection_metadata_create_9() -> CollectionMetadataCreate9:
    return CollectionMetadataCreate9(timestamp=datetime(2016, 1, 6, 23, 59), duration=11.2, fleet_count=1, user_count=1, tourney_running=False, schema_version=9, max_tournament_battle_attempts=6)
